...
def matrix_mul(m_a, m_b):
    ...
    TypeError: exception with the message m_a must be a list
    or m_b must be a list
    TypeError: exception with the message m_a must be a
    list of lists or m_b must be a list of lists
    ValueError: exception with the message m_a can't
    be empty or m_b can't be empty
    TypeError:exception with the message m_a should
