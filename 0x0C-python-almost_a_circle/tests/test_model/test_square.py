...
class TestSquareMethods(unittest.TestCase):
    """ Describes tests for Square class """

    def setUp(self):
        """ Method invoked  each test """
    ...
    def test_attributes_1(self):
        """ Test for width in x and y types"""
    ...
    def test_constructor_no_args(self):
        """ Tests for constructors  no args """
    ...
    def test_C_constructor_many_args(self):
        """ Tests if constructor has many arguments """
        with self.assertRaises(TypeError) as e:
            r = Square(1, 2, 3, 4, 5)
...
were given"
    ...
    def test_is_Rectangle_instance(self):
        """ Tess for Square is a Rectangle instance """
        s1 = Square(1)
    ...
    def test_area_2(self):
        """ Tests after modifying area size """
        r1 = Square(4)
    ...
    def test_area_no_args(self):
        """ Test area that has no arguments"""
        r = Square(5)
        with self.assertRaises(TypeError) as e:
            Square.area()
    ...
    def test_str(self):
        """ Test __str__ return value in a square"""
        s1 = Square(3, 1, 3)
    ...
    def test_str_no_args(self):
        """ Tests __str__  if it has no arguments """
        r = Square(5, 2)
        with self.assertRaises(TypeError) as e:
            Square.__str__()
