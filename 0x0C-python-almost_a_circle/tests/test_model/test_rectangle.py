...
class TestRectangleMethods(unittest.TestCase):
    """ Describes tests for Rectangle class """
    ...
    def test_docstring(self):
        """ Tests for docstring  presence """
        self.assertIsNotNone(Rectangle.__doc__)

    def test_randos_id(self):
        """ Tests for random arguments to be passed """
        r1 = Rectangle(10, 2)
        r2 = Rectangle(2, 10)
    ...
    def test_class(self):
        """ Tests for Rectangles class """
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_class_inheritance(self):
        """ Tests for Rectangles inheritance from Base """
        self.assertTrue(issubclass(Rectangle, Base))

    def test_arg_passed(self):
        """ Tests for passing no argument """
        with self.assertRaises(TypeError):
            Rectangle(20)
            Rectangle()

    def test_constructor_no_args(self):
        """ Tests for constructors no argument"""
...
and 'height'"
    ...
    def test_constructor_one_arg(self):
        """ Testsfor constructor's one argument """
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_width_height_2(self):
        """ Tests for width and height ranges"""
    ...
    def test_area_2(self):
        """ Checking for the return value area """
        r1 = Rectangle(2, 2)
    ...
    def test_basic_display(self):
        """ Tests for  x and y not displayed """
        r1 = Rectangle(4, 6)
        result = "####\n####\n####\n####\n####\n####\n"
    ...
    def test_display_no_args(self):
        """ Tests for display with no arguments """
        r = Rectangle(9, 8)
        with self.assertRaises(TypeError) as e:
            Rectangle.display()
    ...
    def test_str(self):
        """ Tests for __str__ return value """
    ...
    def test_load_from_file_1(self):
        """ Tests load from file if it exists """
        r1 = Rectangle(1, 1)
        r2 = Rectangle(2, 2)
