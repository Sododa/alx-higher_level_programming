...
class Node:
    ...
    @property
    def data(self):
        """Retrieves data field instance.

        Returns: the data field  node.
        """
        return self.__data
    ...
    def next_node(self, value):
        ...
        Raises:
            TypeError: next_node should be a Node object .
        """
...
class SinglyLinkedList:
    ...
    def __str__(self):
        """Represents the class objects a string.
    ...
    def sorted_insert(self, value):
        """Inserts a new node at a position.
